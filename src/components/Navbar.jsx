...
const Navbar = () => {
  ...
  return (
    <nav className="w-full py-5 bg-[#fafafa]/70 backdrop-blur-md sticky top-0 z-50 flex justify-center border-b border-neutral-100">
            ...
            >
              {({ isActive }) => (
                <div className="relative flex items-center">
                  {isActive && (
                    <span className="absolute -left-5 w-2.5 h-2.5 bg-[#fce803] rounded-full animate-[blink_1.5s_infinite]"></span>
                  )}
                  {item.name}
                </div>
              )}
